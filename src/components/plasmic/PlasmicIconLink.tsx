    ...
    import  "./PlasmicIconLink.css" // plasmic-import: 9G4RRMCUbZ/css
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_oAigPHm8VZgjKtAmnNEFkF", "IconLink__root__f4V2U")}
