    ...
    import  "./PlasmicSidebar.css" // plasmic-import: K1s8NJKe19/css
    ...
    function PlasmicSidebar__RenderFunc(
      props: {
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_oAigPHm8VZgjKtAmnNEFkF", "Sidebar__root__ld6To")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__iVdyj")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box___7LmPg")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__wDv74")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__t5DKb")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__bfFe")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__lgkSo")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Sidebar__box__uLuwq")}
    ...
    type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicSidebar__OverridesType, DescendantsType<T>>;
